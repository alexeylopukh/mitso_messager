...
class UploadFileItem extends StatefulWidget {
  final UploadImage uploadImage;

  const UploadFileItem({Key key, @required this.uploadImage}) : super(key: key);

  @override
  _UploadFileItemState createState() => _UploadFileItemState();
}

class _UploadFileItemState extends State<UploadFileItem> {
  @override
  Widget build(BuildContext context) {
    return Container(
      height: 60,
      ...
      child: Align(
        ...
        child: Stack(
          children: <Widget>[
            Padding(
              padding: EdgeInsets.all(5),
              child: Align(alignment: Alignment.center, child: Icon(Icons.source)),
            ),
            if (widget.uploadImage.state == UploadImageState.Uploading)
              Padding(
                padding: EdgeInsets.all(5),
